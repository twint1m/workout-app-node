-- AlterTable
ALTER TABLE "User" ADD COLUMN     "exercise_log_id" INTEGER;
...
-- AddForeignKey
ALTER TABLE "User" ADD CONSTRAINT "User_exercise_log_id_fkey" FOREIGN KEY ("exercise_log_id") REFERENCES "Exercise_log"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Exercise_log" ADD CONSTRAINT "Exercise_log_exercise_log_id_fkey" FOREIGN KEY ("exercise_log_id") REFERENCES "Workout_log"("id") ON DELETE SET NULL ON UPDATE CASCADE;
